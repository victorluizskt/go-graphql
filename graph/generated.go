...
func (ec *executionContext) field_Mutation_createCategory_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewCategoryInput2githubᚗcomᚋdevfullcycleᚋgraphqlᚋgraphᚋmodelᚐNewCategoryInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_createCourse_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewCourse2githubᚗcomᚋdevfullcycleᚋgraphqlᚋgraphᚋmodelᚐNewCourse)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) unmarshalNNewCategoryInput2githubᚗcomᚋdevfullcycleᚋgraphqlᚋgraphᚋmodelᚐNewCategoryInput(ctx context.Context, v any) (model.NewCategoryInput, error) {
	res, err := ec.unmarshalInputNewCategoryInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNNewCourse2githubᚗcomᚋdevfullcycleᚋgraphqlᚋgraphᚋmodelᚐNewCourse(ctx context.Context, v any) (model.NewCourse, error) {
